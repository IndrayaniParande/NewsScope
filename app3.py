        ...
        if st.button("Fetch Latest News"):
            ...
            if 'clickbait_results' in st.session_state:
                ...
                st.markdown("""
                    ...
                    .metric-red [data-testid="stMetricValue"] {
                        background-color: #e74c3c !important;
                        padding: 10px;
                        border-radius: 8px;
                        color: white !important;
                    }
                    .metric-green [data-testid="stMetricValue"] {
                        background-color: #2ecc71 !important;
                        padding: 10px;
                        border-radius: 8px;
                        color: white !important;
                    }
                    .metric-blue [data-testid="stMetricLabel"],
                    .metric-red [data-testid="stMetricLabel"],
                    .metric-green [data-testid="stMetricLabel"] {
    ...
    with tab2:
        ...
        if st.button("Detect Clickbait"):
            if title_input.strip():
                ...
                tweet_summary = clean_summary(summary)
                if label == 1:
